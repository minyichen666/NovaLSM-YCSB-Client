...
public class CoreWorkload extends Workload {
	...
	public static final String FIX_SCAN_LEN_PROPERTY = "fixscanlen";
	public static final String FIX_SCAN_LEN_PROPERTY_DEFAULT = "-1";
	...
	public static final String STRING_KEY_PROPERTY = "stringkey";
	public static final String STRING_KEY_PROPERTY_DEFAULT = "true";
	...
	protected boolean stringkey;
	protected int insertionRetryLimit;
	protected int insertionRetryInterval;
	protected int fixScanLen;
	...
	public void init(Properties p) throws WorkloadException {
		...
		stringkey = Boolean.parseBoolean(
				p.getProperty(STRING_KEY_PROPERTY, STRING_KEY_PROPERTY_DEFAULT));
		...
		if (requestdistrib.compareTo("uniform") == 0) {
			...
			System.out.println("Zipfian Constant = " + zipfianConstant);
		...
		fixScanLen = Integer.parseInt(p.getProperty(FIX_SCAN_LEN_PROPERTY, FIX_SCAN_LEN_PROPERTY_DEFAULT));
	...
	private HashMap<String, ByteIterator> buildSingleValue(String key) {
		...
		if (dataintegrity) {
			...
			data = new StringByteIterator(buildDeterministicValue(key+nextKeynum(), fieldkey));
		}
